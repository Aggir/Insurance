...
class MoamalatPayment extends StatefulWidget {
  ...
  final void Function(TransactionSuccess transactionSuccess) onCompleteSuccess;
...
class _MoamalatPaymentState extends State<MoamalatPayment> {
  ...
  TransactionSuccess handleComplete(String message) {
    ...
    widget.onCompleteSuccess(transaction);
